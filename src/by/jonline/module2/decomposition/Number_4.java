...
public class Number_4 {
	public static void main(String[] args) {
		...
		System.out.println("Наибольшая дистанция между точками с координатами (" + x1 + "," + y1 + ") � (" + x2 + ","
				+ y2 + "). Дистанция между ними равна: " + lengthCalc(coordinate1, coordinate2));

	}

	// определение позиций координат в массиве, наиболее удаленных друг от друга
	...
	// определение расстояния между двумя координатами
