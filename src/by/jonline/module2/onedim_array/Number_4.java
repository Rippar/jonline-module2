...
/*ƒаны действительные числа a1, a2,..., an. ѕомен€ть местами наибольший и наименьший элементы*/
...
public class Number_4 {
	...
	public static int enterFromConsole() {
		...
		System.out.println("¬ведите целое положительное число, которое больше 1: ");
		while (!sc.hasNextInt()) {
			sc.next();
			System.out.println("Ќужно ввести целое положительное число, которое больше 1!: ");
